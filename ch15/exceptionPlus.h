#pragma once
#ifndef EXCEPTIONPLUS_H_
#define EXCEPTIONPLUS_H_
...
public:
	arg_error(double a1 = 0.0, double a2 = 0.0, std::string f = "none", std::string msg = "invalid arguments\n")
